...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        ...
        "     Y el store de RIESGO (`data/pit_risk/`) queda atrás igual: correr\n"
        "     `python scripts/precompute_pit_risk_score.py`. Lo lee el brazo B2 del\n"
        "     T21, que sin él cae al baseline en la cola. Está VERSIONADO, así que\n"
        "     sale en un commit `data(pit)` verificando que sea extensión pura —\n"
        "     este paso faltaba y el store quedó una semana atrás (tareas 42 y 192).\n"
